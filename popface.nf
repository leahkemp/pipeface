...
workflow {
    ...
    if (annotate == 'yes') {
        ...
        vep_annotated_sv_vcf = vep_sv(joint_sv_vcf, ref_file, ref_index_file, vep_db_file, gnomad_db_file, gnomad_db_index_file, cadd_sv_db_file, cadd_sv_db_index_file)
