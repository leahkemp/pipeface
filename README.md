...
*[See the list of software and their versions used by this version of pipeface](./docs/software_versions.txt)* (assuming the default nextflow_pipeface.config file is used).
